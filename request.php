      ...
      <div class='form'>
        <form id='contact_form' action="form.php" method="POST">
          ...
          <input class='required email' name='email' placeholder='EMAIL' type='text'></p>
              ...
              <input type="checkbox" name="Logo" value="yes"> Logo/Visual Identity<br />
              <input type="checkbox" name="StyleGuide" value="yes"> Style Guide<br />
              <input type="checkbox" name="Consultancy" value="yes"> UX Design & Consultation<br />
              <input type="checkbox" name="Copywriting" value="yes"> Copywriting<br />
              <input type="checkbox" name="Usability" value="yes"> Usability Audit<br />
              <input type="checkbox" name="Research" value="yes"> User Research<br /></p>
              ...
              Are you interested to apply for Open Tech Fund's Usability Lab if your project meets the criteria? Read more <a href="https://www.opentech.fund/lab/usability-lab" target="_blank">here</a>:</p>
               <input type="radio" name="Usability Lab" value="Yes, interested"> Yes<br>
               <input type="radio" name="Usability Lab" value="No, not interested"> No<br>
              <div class="one spacing"></div>
          ...
          <div class='spacing'></div>
            <input class="button boxed black" type="submit" value="Submit">
        </form>
      </div>
    </div>
  </div>
